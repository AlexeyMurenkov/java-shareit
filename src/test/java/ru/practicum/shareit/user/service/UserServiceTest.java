...
class UserServiceTest {
    ...
    UserService userService = new UserServiceImpl(userRepository, new ModelValidator<>());
    ...
    void createUserWithInvalidEmail() {
        final UserDto userDto = UserDto.of(1L, "Invalid", "Invalid");

        Throwable e = assertThrows(ValidationException.class, () -> userService.createUser(userDto));
        assertEquals("Ошибка валидации", e.getMessage(), "Неверное сообщение об ошибке");
    }
